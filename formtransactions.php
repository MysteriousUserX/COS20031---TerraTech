                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span
                                            class="alert"><?php echo $formSubmitted ? ($errors['EndDate'] ?? '') : ''; ?></span>
                                    </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span
                                            class="alert"><?php echo $formSubmitted ? ($errors['AgentName'] ?? '') : ''; ?></span>
                                    </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="FirstPartyName" id="form-party-name-1" type="text"
                                            class="form-control" placeholder="First party name...">
                                        <span
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">First party's role <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Second party's role <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span
                                            class="alert"><?php echo $formSubmitted ? ($errors['DocumentType'] ?? '') : ''; ?></span>
                                    </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <span
                                            class="alert"><?php echo $formSubmitted ? ($errors['DocumentContent'] ?? '') : ''; ?></span>
                                    </div>
                                </div>
                                <!--end col-->
