                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-12 text-center">
                        <div class="title-heading text-center">
                            <h4 class="heading fw-bold text-white title-dark mb-3">Easy way to find your <br> dream property</h4>
                            <p class="para-desc text-white-50 title-dark mx-auto mb-0">A great platform to buy, sell and rent your properties without any agent or commisions.</p>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            ...
                            <p class="text-muted para-desc mb-0">TerraTech developed a platform for the Real Estate marketplace that allows buyers and sellers to easily execute a transaction on their own. The platform drives efficiency, cost transparency and control into the hands of the consumers. TerraTech is Real Estate Redefined.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col">
                        <div class="section-title mb-4 pb-2">
                            ...
                            <p class="text-muted para-desc mb-0">A great platform to buy, sell and rent your properties without any agent or commisions.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col">
                        <div class="section-title text-center mb-4 pb-2">
                            ...
                            <p class="text-muted para-desc mb-0 mx-auto">A great platform to buy, sell and rent your properties without any agent or commisions.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            ...
            <div class="container mt-100 mt-60">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-7 mt-4">
                        <i class="mdi mdi-format-quote-open display-1 position-absolute start-0 top-0" style="opacity: 0.05;"></i>
                        <i class="mdi mdi-format-quote-open display-1 position-absolute end-0 bottom-0" style="opacity: 0.05;"></i>
                        <div class="tiny-single-item">
                            <div class="tiny-slider client-testi">
                                <div class="text-center">
                                    <div class="m-2">
                                        <img src="images/client/01.jpg" class="avatar avatar-small rounded-circle shadow-md" alt="">
                                        <div class="flex-1 mt-4">
                                            <h6 class="mb-0">Young Bonetti</h6>
                                            <small class="text-muted">Product Manager</small>
                                        </div>
                                        
                                        <p class="text-muted fst-italic mb-0 mt-3">" It seems that only fragments of the original text remain in the Lorem Ipsum texts used today. One may speculate that over the course of time certain letters were added or deleted at various positions within the text. "</p>
                            ...
                            <div class="tiny-slider client-testi">
                                <div class="text-center">
                                    <div class="m-2">
                                        <img src="images/client/02.jpg" class="avatar avatar-small rounded-circle shadow-md" alt="">
                                        <div class="flex-1 mt-4">
                            ...
                            <div class="tiny-slider client-testi">
                                <div class="text-center">
                                    <div class="m-2">
                                        <img src="images/client/03.jpg" class="avatar avatar-small rounded-circle shadow-md" alt="">
                                        <div class="flex-1 mt-4">
                            ...
                            <div class="tiny-slider client-testi">
                                <div class="text-center">
                                    <div class="m-2">
                                        <img src="images/client/04.jpg" class="avatar avatar-small rounded-circle shadow-md" alt="">
                                        <div class="flex-1 mt-4">
                            ...
                            <div class="tiny-slider client-testi">
                                <div class="text-center">
                                    <div class="m-2">
                                        <img src="images/client/05.jpg" class="avatar avatar-small rounded-circle shadow-md" alt="">
                                        <div class="flex-1 mt-4">
                            ...
                            <div class="tiny-slider client-testi">
                                <div class="text-center">
                                    <div class="m-2">
                                        <img src="images/client/06.jpg" class="avatar avatar-small rounded-circle shadow-md" alt="">
                                        <div class="flex-1 mt-4">
