                                    ...
                                    <div class="row g-lg-0">
                                        <div class="col-lg-3 col-md-6 col-12">
                                            <div class="mb-3 mb-sm-0">
                                                <label for="transaction-name-keyword"
                                                    class="form-label d-none fs-6">Search :</label>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            <div class="mb-3 mb-sm-0">
                                                <label class="form-label d-none fs-6">Select type of
                                                    transaction:</label>
                                                <div class="filter-search-form position-relative filter-border">
                                                    <select class="form-select select-transaction-type"
                                                        id="choices-transaction-type" name="TransactionType">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            <div class="mb-3 mb-sm-0">
                                                ...
                                                <div class="filter-search-form position-relative">
                                                    <select class="form-select select-document-type"
                                                        id="choices-document-type" name="DocumentType">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            <input type="submit" id="search" name="transaction-search-bar"
                    ...
                    <div class="pagination">
                        ...
                        <?php 
                            if(isset($_GET['page-number']) && $_GET['page-number'] > 1){
                                ?> <a href="?page-number=<?php echo $_GET['page-number'] - 1 ?>">
                            << /a> <?php
                            }else{
                                ?> <a>«</a> <?php
                            }
                                    ...
                                    if ($number_of_pages > 1) {
                                        ...
                                        for ($i = max(1, $page - 2); $i <= min($number_of_pages, $page + 2); $i++) {
                                            if($i == @$_GET['page-number']) {
                                                ?> <a class="active"
                                        href="?page-number=<?php echo $i ?>"><?php echo $i ?></a> <?php
                                            }else{
