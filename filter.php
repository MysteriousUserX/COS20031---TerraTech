            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-12">
                    <div class="title-heading text-center">
                        ...
                        <h5 class="heading fw-semibold mb-0 sub-heading text-white title-dark">Find Transaction
                            Visualization</h5>
                    </div>
                </div>
                <!--end col-->
                                    ...
                                    <form style="max-width: 800px;" id="propertyForm">
                                        <div class="mb-0">
                                            <input type="text" id="searchTerm" name="searchTerm"
                                                class="border shadow rounded-3 bg-white"
                                                placeholder="Enter property ID number">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>Individual</td>
                        <td>
                            <div class="color-box circle" style="background-color: pink;"></div>
                        </td>
                    </tr>
                    <tr>
                        <td>Organization</td>
                        <td>
                            <div class="color-box diamond" style="background-color: yellow;"></div>
                        </td>
                    </tr>
                    <tr>
                        <td>Government</td>
                        <td>
                            <div class="color-box house" style="background-color: orange;"></div>
                        </td>
                    </tr>
                </tbody>
                <thead>
